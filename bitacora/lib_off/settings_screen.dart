  ...
  Future<void> _clear() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂBorrar todas las configuraciones? Esta acciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n no se puede deshacer.',
        ),
        actions: [
        ...
        child: ListView(
          children: [
            const Padding(
              ...
              child: Text('EnvÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­o rÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡pido', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
            ),
            Padding(
            ...
            const Padding(
              ...
              child: Text(
                'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Si hay endpoint, los Excel se envÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­an por HTTP.\n'
                    'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Si no hay endpoint y hay email, se abre el envÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­o por correo.\n'
                    'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Ambos campos son opcionales; usa el que prefieras.',
