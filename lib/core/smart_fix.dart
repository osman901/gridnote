...
/// Extensión segura para evitar "setState() called after dispose()"
...
final List<_Rule> _defaultRules = <_Rule>[
  // 1) Desborde de layout (RenderFlex overflow): no se puede “arreglar” aquí,
  ...
  // 2) setState() después de dispose: sólo avisamos, usar safeSetState en código.
  _Rule(
  ...
  _Rule(
    'Intl fallback',
        ...
        (e, _) async {
      debugPrint('[SmartFix] Re-inicializando Intl (es)…');
