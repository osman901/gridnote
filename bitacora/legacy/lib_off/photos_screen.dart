...
class _PhotosScreenState extends State<PhotosScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text('Fotos ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ ${widget.meta.name}')),
      ...
      body: Stack(
        children: [
          ...
          if (_loading)
            ...
            const Center(child: Text('Sin fotos aÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºn'))
          else
            Padding(
  ...
  Widget _fab() => PopupMenuButton<String>(
    itemBuilder: (_) => const [
      PopupMenuItem(
        value: 'cam',
        child: ListTile(leading: Icon(Icons.photo_camera), title: Text('CÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡mara')),
      ),
      PopupMenuItem(
        value: 'gal',
        child: ListTile(leading: Icon(Icons.photo_library), title: Text('GalerÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­a')),
      ),
    ],
    onSelected: (v) async {
      try {
