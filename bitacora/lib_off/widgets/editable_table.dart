...
/// Tabla editable tipo ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œhoja de cÃƒÆ’Ã‚Â¡lculo ligeraÃƒÂ¢Ã¢â€šÂ¬Ã‚Â.
...
class _EditableTableState extends State<EditableTable> {
  ...
  void _saveRow(int i) {
    ...
    updated[i] = updated[i].copyWith(
      ...
      // La fecha se muestra pero no se edita aquÃƒÆ’Ã‚Â­.
    );

    // El padre debe reconstruir con la nueva lista
  ...
  // Formateo local DD/MM/YYYY para DateTime (o '-' si no hay fecha).
