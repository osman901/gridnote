                  ...
                  children: [
                    ...
                    if (_range != null)
                      InputChip(
                        ...
                        label: Text(
                          '${DateFormat('dd/MM/yy').format(_range!.start)} ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ ${DateFormat('dd/MM/yy').format(_range!.end)}',
                        ),
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(
                        '${_dateFmt.format(it.modified)} ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ ${formatSize(it.sizeBytes)} ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ ${it.origin}',
                      ),
