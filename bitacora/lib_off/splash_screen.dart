...
import 'package:bitacora/widgets/arrow_loader.dart'; // ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ Ãƒâ€šÃ‚Â usa package: para evitar paths rotos
        ...
        child: const Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 18),
              _ShimmerText('Cargando GridnoteÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦'),
            ],
          ),
        ),
      ),
    ...
    return AnimatedBuilder(
      ...
      builder: (_, __) {
        return ShaderMask(
          ...
          child: const Text(
            'Cargando GridnoteÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦',
            style: TextStyle(
