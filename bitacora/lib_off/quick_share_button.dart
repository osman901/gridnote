...
class _QuickShareButtonState extends State<QuickShareButton> {
  ...
  final QuickMailService _mail = const QuickMailService(); // ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ fijo el error
  bool _sending = false;
                    ...
                    onPressed: _sending
                      ...
                      if (!_valid(email)) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('IngresÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ un correo vÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡lido'),
                          ),
                        );
                        return;
                      }
                      ...
                      try {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Abriendo app de correo para ${widget.meta.name}ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦',
                            ),
                          ),
                        );
                      } finally {
