...
bool get hasQuickSendTarget => (_endpoint?.isNotEmpty ?? false) || (_defaultEmail?.isNotEmpty ?? false);
...
if (uri == null || uri.host.isEmpty || !(uri.isScheme('http') || uri.isScheme('https'))) {
