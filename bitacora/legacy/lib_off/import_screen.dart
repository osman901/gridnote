...
class _ImportScreenState extends ConsumerState<ImportScreen> {
  ...
  Future<void> _commit() async {
    ...
    // ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ usar el provider *family* con el id de la planilla para acceder al notifier
    ref.read(measurementAsyncProvider(widget.meta.id).notifier).setAll(_preview);
    if (!mounted) return;
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('ImportaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n completa')));
