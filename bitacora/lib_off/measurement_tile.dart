    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              // ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âcono o avatar
              Container(
                width: 40,
                height: 40,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          '1mÃƒÆ’Ã…Â½Ãƒâ€šÃ‚Â©: ${measurement.ohm1m}',
                          style: TextStyle(color: theme.textFaint, fontSize: 12),
                        ),
                        ...[
                        const SizedBox(width: 8),
                        Text(
                          '3mÃƒÆ’Ã…Â½Ãƒâ€šÃ‚Â©: ${measurement.ohm3m}',
                          style: TextStyle(color: theme.textFaint, fontSize: 12),
                        ),
                      ],
                      ],
              ...
              // Icono de navegaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n
              Icon(
                Icons.chevron_right,
