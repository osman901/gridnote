...
class _LicenseActivationScreenState extends State<LicenseActivationScreen> {
  ...
  Future<void> _activate() async {
    ...
    setState(() { _busy = false; _msg = ok ? 'Licencia activada' : 'Clave invÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡lida'; });
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Gridnote ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Licencia requerida', style: Theme.of(context).textTheme.titleLarge),
                    const SizedBox(height: 8),
                    Text(widget.status.hasValidLicense ? 'Tu licencia venciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³.' : 'Tu prueba terminÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³.', textAlign: TextAlign.center),
                    const SizedBox(height: 12),
                    if (widget.status.expiresAtUtc != null)
                      Text(
                        'ExpirÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³: ${widget.status.expiresAtUtc!.toLocal()}',
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Clave de activaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n',
                        hintText: 'pega aquÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­ tu clave firmada',
