...
/// cuando hay jank sostenido. Útil para desactivar blur/sombras en
...
class PerfBoost extends ChangeNotifier {
  ...
  bool _started = false;
  int _window = 120;               // tamaño de ventana (frames)
  ...
  void start({
    ...
    SchedulerBinding.instance.addTimingsCallback((List<FrameTiming> timings) {
      for (final t in timings) {
        // Usamos la fase de raster como indicador de “costo”.
