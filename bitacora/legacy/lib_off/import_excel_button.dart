  ...
  Widget build(BuildContext context) {
    return IconButton(
      ...
      onPressed: () async {
        ...
        if (parsed.isEmpty) {
          messenger.showSnackBar(
            const SnackBar(content: Text('No se encontraron filas vÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡lidas')),
          );
          return;
        }
        ...
        final ok = await showDialog<bool>(
          ...
          builder: (_) => AlertDialog(
            ...
            content: Text('Se detectaron ${parsed.length} mediciones. ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂImportar ahora?'),
            actions: [
              TextButton(
