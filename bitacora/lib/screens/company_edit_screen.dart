...
class _CompanyEditScreenState extends State<CompanyEditScreen> {
  ...
  Future<void> _pickLogo() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content:
              Text('No se pudo seleccionar la imagen. VerificÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ los permisos.'),
        ),
      );
    }
  }
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      // AjustÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ estas llamadas segÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºn tu API real (estÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡tico vs instancia).
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Error: No se pudo guardar la informaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n.')),
        );
      }
    } finally {
