...
class NoteItem {
  ...
  final String thumbUrl;   // usa tus assets si querés
  final String body;
...
class _BitacoraPageState extends State<BitacoraPage> {
  final notes = <NoteItem>[
    ...
    NoteItem(
      ...
      body: 'Otra nota de muestra con descripción corta.',
    ),
  ];
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, c) {
          ...
          // Teléfono: lista; navega a detalle
          return _SidebarList(
            notes: notes,
            selected: selected,
            onTap: (i) {
  ...
  Future<void> _exportAndShare(NoteItem n) async {
    ...
    await Share.shareXFiles(
      ...
      text: 'Bitácora – ${n.title}',
      subject: 'Bitácora – ${n.title}',
    );
  }
}
