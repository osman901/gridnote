...
class _LocationScreenState extends ConsumerState<LocationScreen> {
  ...
  Future<void> _saveFromGPS() async {
    // GPS apagado ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ abrir ajustes
    ...
    // Obtener posiciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n
    ...
    if (!GeoUtils.isValid(pos.latitude, pos.longitude)) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Lectura GPS invÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡lida. IntentÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ de nuevo.')),
      );
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    final coordsText = hasCoords
        ...
        : 'Sin ubicaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n guardada';

    return Scaffold(
      backgroundColor: t.scaffold,
      appBar: AppBar(title: const Text('UbicaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n general')),
      body: Padding(
