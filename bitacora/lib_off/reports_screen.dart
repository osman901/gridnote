...
class ReportsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Future<void> shareXlsx(List<Measurement> rows) async {
      ...
      await Share.shareXFiles([XFile(file.path)], text: 'Reporte XLSX ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ ${meta.name}');
    }
    ...
    Future<void> sharePdf(List<Measurement> rows) async {
      ...
      await Share.shareXFiles([XFile(file.path)], text: 'Reporte PDF ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ ${meta.name}');
    }
