// Gridnote · LocationFixCoordinator · 2025-09
// Evita (0,0) en guardados rápidos: serializa lecturas, cachea el último fix
// válido (LKGF), reintenta cortito y bloquea escrituras inválidas.
...
class LocationFixCoordinator {
  ...
  /// - Reintenta 1 vez si la lectura falla.
