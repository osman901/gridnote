...
/// Botón OCR (placeholder): abre un mini formulario para ingresar 1m/3m.
/// Más adelante podés cambiar la lógica por OCR real.
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          TextField(controller: _c1, keyboardType: const TextInputType.numberWithOptions(decimal: true), decoration: const InputDecoration(labelText: '1m (Ω)')),
          TextField(controller: _c3, keyboardType: const TextInputType.numberWithOptions(decimal: true), decoration: const InputDecoration(labelText: '3m (Ω)')),
        ],
      ),
      actions: [
