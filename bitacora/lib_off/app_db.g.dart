...
class $SheetsTable extends Sheets with TableInfo<$SheetsTable, SheetRow> {
  @override
  ...
  @override
  VerificationContext validateIntegrity(Insertable<SheetRow> instance,
  ...
  @override
  SheetRow map(Map<String, dynamic> data, {String? tablePrefix}) {
...
class SheetRow extends DataClass implements Insertable<SheetRow> {
  final int id;
  final String name;
  final int version;
  ...
  SheetRow copyWithCompanion(SheetsCompanion data) {
    return SheetRow(
...
class SheetsCompanion extends UpdateCompanion<SheetRow> {
  final Value<int> id;
  ...
  static Insertable<SheetRow> custom({
    Expression<int>? id,
...
final class $$SheetsTableReferences
    extends BaseReferences<_$AppDb, $SheetsTable, SheetRow> {
...
class $$SheetsTableTableManager extends RootTableManager<
    ...
    (SheetRow, $$SheetsTableReferences),
    SheetRow,
          ...
          prefetchHooksCallback: ({entriesRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (entriesRefs)
                    await $_getPrefetchedData<SheetRow, $SheetsTable, EntryRow>(
                        currentTable: table,
                        referencedTable:
...
final class $$EntriesTableReferences
    extends BaseReferences<_$AppDb, $EntriesTable, EntryRow> {
  ...
  static MultiTypedResultKey<$AttachmentsTable, List<AttachmentRow>>
      _attachmentsRefsTable(_$AppDb db) =>
          ...
          prefetchHooksCallback: ({sheetId = false, attachmentsRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (attachmentsRefs)
                    await $_getPrefetchedData<EntryRow, $EntriesTable,
                            AttachmentRow>(
                        currentTable: table,
                        referencedTable:
...
final class $$AttachmentsTableReferences
    extends BaseReferences<_$AppDb, $AttachmentsTable, AttachmentRow> {
