...
// Ed25519 offline + trial 30 dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­as.
...
class LicenseManager {
  ...
  // ReemplazÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ por tu clave pÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºblica real (base64 estÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ndar, 32 bytes).
    ...
    if (lastSeenStr != null) {
      ...
      if (now.isBefore(lastSeen.subtract(const Duration(hours: 48)))) {
        return const LicenseStatus(
          ...
          expiresAtUtc: null,
          daysLeft: 0,
          reason: 'Reloj alterado. ConectÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ a internet para validar hora.',
        );
      }
    }
  ...
  String humanStatus(LicenseStatus s) {
    ...
    return s.allowed
        ? '${s.hasValidLicense ? 'Licencia' : 'Prueba'}: ${s.daysLeft} dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­as restantes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ exp: $exp'
        : s.reason;
  }
}
