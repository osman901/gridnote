...
class SafeLocation {
  ...
  /// Devuelve una posición **segura**:
  /// 1) actual con alta precisión y timeout
  /// 2) si falla, última conocida, válida y reciente
  Future<Position?> getSafePosition() async {
    ...
    // 2) Última conocida (si es válida y reciente)
    try {
  ...
  /// Abre Google Maps / app de mapas si las coords son válidas
