...
class SignaturePadController extends ChangeNotifier {
  ...
  /// Exporta el contenido como PNG. Devuelve null si el render aÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºn no estÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ listo.
...
/// Widget del ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡rea de firma.
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final s in strokes) {
      ...
      if (s.points.length == 1) {
        // Punto ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºnico (toque breve)
        canvas.drawPoints(
          ui.PointMode.points,
          s.points,
