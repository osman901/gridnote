...
class _QuickHubOverlayState extends State<_QuickHubOverlay> {
  ...
  void initState() {
    super.initState();
    // pequeña demora para animar aparición
            ...
            child: AnimatedContainer(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const Text("Atajos rápidos", style: TextStyle(fontWeight: FontWeight.w600)),
                  IconButton(
...
class _QuickGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = <_QuickItem>[
      _QuickItem("Nueva medición", Icons.add_circle, () => Navigator.pushNamed(context, "/new")),
      ...
      _QuickItem("Ubicación", Icons.place_rounded, () => Navigator.pushNamed(context, "/location")),
