...
class _EditMeasurementSheetState extends State<EditMeasurementSheet> {
  ...
  bool _validate() {
    ...
    if (_ohm1.text.trim().isNotEmpty && _numOrNull(_ohm1.text) == null) _errOhm1 = 'Número inválido';
    if (_ohm3.text.trim().isNotEmpty && _numOrNull(_ohm3.text) == null) _errOhm3 = 'Número inválido';
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(labelText: '1 m (Ω)', errorText: _errOhm1),
                  ...
                  Expanded(
                    child: TextField(
                      controller: _ohm3,
                      keyboardType: const TextInputType.numberWithOptions(decimal: true, signed: false),
                      decoration: InputDecoration(labelText: '3 m (Ω)', errorText: _errOhm3),
                      onChanged: (_) => _validate(),
                    ),
                  ),
                ],
