                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: const InputDecoration(labelText: '1 m (ÃƒÆ’Ã…Â½Ãƒâ€šÃ‚Â©)'),
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: const InputDecoration(labelText: '3 m (ÃƒÆ’Ã…Â½Ãƒâ€šÃ‚Â©)'),
                        keyboardType: const TextInputType.numberWithOptions(decimal: true),
                        inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'[0-9\.,-]'))],
