...
class _ExpandableFabState extends State<ExpandableFab>
  ...
  void initState() {
    ...
    _rotate = Tween<double>(begin: 0, end: 0.125).animate(_ctl); // +45°
  }
  ...
  Widget build(BuildContext context) {
    // Ocupa toda la pantalla para poder poner la barrera táctil
...
class _ExpandingActionButton extends StatelessWidget {
  ...
  final int indexFromBottom; // 1 = primer botón arriba del FAB principal
  final double distance;
