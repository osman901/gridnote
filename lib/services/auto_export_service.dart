...
import 'notification_service.dart'; // ✅ nombre correcto
...
class AutoExportService {
  ...
  /// …/Android/data/<package>/files/Gridnote/
  ...
  static Future<void> exportAndNotify({
    ...
    await NotificationService.instance.showSavedSheet( // ✅ clase/método correctos
